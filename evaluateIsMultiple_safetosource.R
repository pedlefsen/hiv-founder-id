    ...
    bound.and.evaluate.is.multiple.results.per.ppt <-
       ...
       if( use.glm.validate || use.lasso.validate ) {
        ...
        ## Try removing some variables that are rarely selected or are too correlated (eg diversity is highly correlated with sd.entropy, max.hd, insites.is.one.founder, insites.founders) [SEE BELOW WHERE WE ADD TO THIS PROGRAMMATICALLY]
           .donotkeep.cols <- c( "multifounder.DSStarPhyTest.R", "multifounder.Synonymous.DSStarPhyTest.R", "PFitter.chi.sq.stat", "Synonymous.DSStarPhyTest.R", "StarPhy.is.one.founder", "DSStarPhyTest.fits", "DSStarPhyTest.is.starlike", "insites.is.one.founder", "inf.to.priv.ratio" );
        ...
        stopifnot( all( estimate.cols %in% colnames( results.covars.per.person.with.extra.cols ) ) );
...
#  [2] "diversity"                                    
#  [3] "priv.sites"                                   
#  [4] "multifounder.Synonymous.DSStarPhyTest.R"         
#  [5] "DSStarPhyTest.R"                                 
...
#  [9] "v3_not_nflg"                                  
# [10] "lPVL"
#        evaluate.specific.isMultiple.model( model.vars = c( "multifounder.Synonymous.PFitter.mut.rate.coef", "diversity", "priv.sites", "multifounder.Synonymous.DSStarPhyTest.R", "DSStarPhyTest.R", "sampledwidth_uniform_1mmtn003_6mhvtn502.lower", "inf.sites.clusters", "sampledwidth_uniform_1mmtn003_6mhvtn502.upper", "v3_not_nflg", "lPVL" ) );
#         Call:
...
# multifounder.Synonymous.DSStarPhyTest.R           7.537e-01  6.115e+00   0.123
# DSStarPhyTest.R                                   3.757e+00  3.259e+00   1.153
...
# diversity                                      0.00787 **
# priv.sites                                     0.34591   
# multifounder.Synonymous.DSStarPhyTest.R           0.90191   
# DSStarPhyTest.R                                   0.24892   
...
#     diversity + DSStarPhyTest.R + sampledwidth_uniform_1mmtn003_6mhvtn502.lower + 
...
# - DSStarPhyTest.R                                   1   35.362  49.362
...
# DSStarPhyTest.R                                   5.626e+00  2.605e+00   2.160
