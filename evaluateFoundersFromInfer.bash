...
do
    echo ${fasta_prefix}
    export evaluateFounders_estimatesFilename_single="${inputDir}/${fasta_prefix}.outsingle.fa";
    export evaluateFounders_estimatesFilename_multiple="${inputDir}/${fasta_prefix}.outmultiple.fa";
