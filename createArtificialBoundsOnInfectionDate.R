...
} # uniform.deterministic.interval.generation.fn ( .. )

test.uniform.deterministic.interval.generation.fn () {
...
## Uniform, 5 weeks.
set.seed( 98103 );
createArtificialBoundsOnInfectionDate( interval.width.in.days = ( 5 * 7 ), interval.generation.fn = uniform.interval.generation.fn, output.file.suffix = "uniform_5weeks.tab" );
