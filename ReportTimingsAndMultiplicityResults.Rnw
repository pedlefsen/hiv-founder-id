...
# this provides "inverse.epsilon" and some other values we will use:
source( "~/src/from-git/hiv-founder-id/daysFromLambda_safetosource.R" )
...
uncalibrated.v3.1m.days   <- read.csv( "Uncalibrated Estimators of v3 Days at 1m data.csv"   );
uncalibrated.v3.6m.days   <- read.csv( "Uncalibrated Estimators of v3 Days at 6m data.csv"   );
uncalibrated.nflg.1m.days <- read.csv( "Uncalibrated Estimators of nflg Days at 1m data.csv" );
uncalibrated.nflg.6m.days <- read.csv( "Uncalibrated Estimators of nflg Days at 6m data.csv" );
...
cors <- list( "nflg 1m" = cor( uncalibrated.nflg.1m.days[ , "Gold.Standard" ], uncalibrated.nflg.1m.days[ , "Center.of.Bounds" ] ), "nflg 6m" = cor( uncalibrated.nflg.6m.days[ , "Gold.Standard" ], uncalibrated.nflg.6m.days[ , "Center.of.Bounds" ] ), "v3 1m" = cor( uncalibrated.v3.1m.days[ , "Gold.Standard" ], uncalibrated.v3.1m.days[ , "Center.of.Bounds" ] ), "v3 6m" = cor( uncalibrated.v3.6m.days[ , "Gold.Standard" ], uncalibrated.v3.6m.days[ , "Center.of.Bounds" ] ) );
...
# $`v3 6m`
# [1] 0.1836405
lapply( cors, function( .x ) { sprintf( "%0.2f", .x ) } )
# $`nflg 1m`
# [1] "0.45"
# 
# $`nflg 6m`
...
## More info:
# > cor.test( uncalibrated.v3.1m.days[ , "Gold.Standard" ], uncalibrated.v3.1m.days[ , "Center.of.Bounds" ] )
# 
# 	Pearson's product-moment correlation
# 
# data:  uncalibrated.v3.1m.days[, "Gold.Standard"] and uncalibrated.v3.1m.days[, "Center.of.Bounds"]
# t = 1.6997, df = 18, p-value = 0.1064
# alternative hypothesis: true correlation is not equal to 0
# 95 percent confidence interval:
#  -0.08454304  0.69932430
# sample estimates:
#       cor 
# 0.3718909 
# 
# > cor.test( uncalibrated.v3.6m.days[ , "Gold.Standard" ], uncalibrated.v3.6m.days[ , "Center.of.Bounds" ] )
# 
# 	Pearson's product-moment correlation
# 
# data:  uncalibrated.v3.6m.days[, "Gold.Standard"] and uncalibrated.v3.6m.days[, "Center.of.Bounds"]
# t = 0.74727, df = 16, p-value = 0.4657
# alternative hypothesis: true correlation is not equal to 0
# 95 percent confidence interval:
#  -0.3097898  0.5991423
# sample estimates:
...
# 0.1836405 
# 
# > cor.test( uncalibrated.nflg.1m.days[ , "Gold.Standard" ], uncalibrated.nflg.1m.days[ , "Center.of.Bounds" ] )
# 
# 	Pearson's product-moment correlation
# 
# data:  uncalibrated.nflg.1m.days[, "Gold.Standard"] and uncalibrated.nflg.1m.days[, "Center.of.Bounds"]
# t = 2.9523, df = 34, p-value = 0.005684
# alternative hypothesis: true correlation is not equal to 0
# 95 percent confidence interval:
#  0.1446390 0.6794181
# sample estimates:
...
# 0.4517099 
# 
# > cor.test( uncalibrated.nflg.6m.days[ , "Gold.Standard" ], uncalibrated.nflg.6m.days[ , "Center.of.Bounds" ] )
# 
# 	Pearson's product-moment correlation
# 
# data:  uncalibrated.nflg.6m.days[, "Gold.Standard"] and uncalibrated.nflg.6m.days[, "Center.of.Bounds"]
# t = 2.0856, df = 32, p-value = 0.04508
# alternative hypothesis: true correlation is not equal to 0
# 95 percent confidence interval:
#  0.00877993 0.61244214
# sample estimates:
#       cor 
# 0.3459186 
