...
### To evaluate the isMultiple calls, we use evaluateIsMultiple.bash, which creates two output files in the given dir.
...
### Now we need to gather the evaluateFounders.tbl results.  We do this manually for now (TODO: Automate it).  We just cat all the results tables together then remove the extraneous headers manually in emacs.

## nflg:
cat /fh/fast/edlefsen_p/bakeoff_analysis_results/raw_edited_20160216/nflg/1m/*/evaluateFounders.tbl > /fh/fast/edlefsen_p/bakeoff_analysis_results/raw_edited_20160216/nflg/1m/evaluateFounders.tbl
cat /fh/fast/edlefsen_p/bakeoff_analysis_results/raw_edited_20160216/nflg/6m/*/evaluateFounders.tbl > /fh/fast/edlefsen_p/bakeoff_analysis_results/raw_edited_20160216/nflg/6m/evaluateFounders.tbl
### TODO again after evaluateAllFounders stops runnning...
cat /fh/fast/edlefsen_p/bakeoff_analysis_results/raw_edited_20160216/nflg/1m6m/*/evaluateFounders.tbl > /fh/fast/edlefsen_p/bakeoff_analysis_results/raw_edited_20160216/nflg/1m6m/evaluateFounders.tbl
