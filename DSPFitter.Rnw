...
## Could add Bayesian.  Congjugate prior is Gamma, and Gamma( 1, 1 ) (expo) has log( x ) propto 1.  However alpha and beta approaching zero might give the closest analogue to the DS solution.
