    ## This is originally frmo PFitter, but daysFromLambda has been modified to take inverse.lambda instead of lambda.  Epsilon is the per position mutation rate, per generation -- but I think that the generations / day is fixed at 2, so really this is the mutation rate position per half-day.
